...
**Update:** project can demonstrate how a traditional supervised machine learning classifier can be extended into an **agentic system** by layering decision policies, tool usage, and memory on top of the model.
